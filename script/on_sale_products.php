...
$sql = "SELECT `product_name`, `company_name`, `real_amount`, `discounted_amount`, `image_1`, `image_2`, `image_3`, `image_4`, `image_5`, `image_6`, product.`id`, `tag`, `long_description`, `short_description` FROM `product`,on_sale_products WHERE product_id = product.id LIMIT 0,3";
