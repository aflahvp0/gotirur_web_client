...
<div id="single-product">
    <div class="container">
        ...
        <?php
//        require_once '/../script/gallery_single_product.php';
//        require MC_ROOT . '/script/gallery_single_product.php';
//        require MC_ROOT . '/parts/section/single-product-gallery.php';
        ?>
                ...
                <div id="owl-single-product">
                    <div class="single-product-gallery-item" id="slide1">
                        <a data-rel="prettyphoto" href="images/products/<?php echo $row['image_1'] ?>.jpg">
                             ...
                             <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/products/<?php echo $row['image_1'] ?>.jpg" />';
<!--//                            echo ' <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/products/';
//                            echo $row['image_1'];
//                            echo '.jpg" />';
//                           -->
                        </a>
                    ...
                    <div class="single-product-gallery-item" id="slide2">
                        <a data-rel="prettyphoto" href="images/products/<?php echo $row['image_2'] ?>.jpg">
                            <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/products/<?php echo $row['image_2'] ?>.jpg" />
                        </a>
                    </div><!-- /.single-product-gallery-item -->

                    <div class="single-product-gallery-item" id="slide3">
                        <a data-rel="prettyphoto" href="images/products/<?php echo $row['image_3'] ?>.jpg">
                            <img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="assets/images/products/<?php echo $row['image_3'] ?>.jpg" />
                        </a>
                    </div><!-- /.single-product-gallery-item -->
